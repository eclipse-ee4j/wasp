...
import org.glassfish.wasp.xmlparser.XMLEncodingDetector;
...
class ParserController implements TagConstants {
     ...
     */
    public Node.Nodes parse(String inFileName) throws FileNotFoundException, WaspException, IOException {
     ...
     * from the filesystem
     */
    public Node.Nodes parse(String inFileName, Node parent, URL jarFileUrl) throws FileNotFoundException, WaspException, IOException {
     ...
     */
    public Node.Nodes parseTagFileDirectives(String inFileName) throws FileNotFoundException, WaspException, IOException {
     ...
     */
    private Node.Nodes doParse(String inFileName, Node parent, URL jarFileUrl) throws FileNotFoundException, WaspException, IOException {
     ...
     *
     * @throws WaspException if page encoding mismatch
     */
    private void comparePageEncodings(String jspConfigPageEnc) throws WaspException {
     ...
     */
    private String getJspConfigPageEncoding(String absFileName) throws WaspException {
     ...
     */
    private void determineSyntaxAndEncoding(String absFileName, JarFile jarFile, String jspConfigPageEnc) throws WaspException, IOException {
     ...
     */
    private String getPageEncodingForJspSyntax(JspReader jspReader, Mark startMark) throws WaspException {
     ...
     */
    private boolean hasJspRoot(JspReader reader) throws WaspException {
