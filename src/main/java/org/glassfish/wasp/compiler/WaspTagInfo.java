 ...
 */
class WaspTagInfo extends TagInfo {

    private String dynamicAttrsMapName;

    public WaspTagInfo(String tagName, String tagClassName, String bodyContent, String infoString, TagLibraryInfo taglib, TagExtraInfo tagExtraInfo,
