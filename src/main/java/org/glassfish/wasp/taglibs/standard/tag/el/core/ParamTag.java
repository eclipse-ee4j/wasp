...
public class ParamTag extends ParamSupport {
    ...
    private void evaluateExpressions() throws JspException {
        ...
        name = (String) ExpressionUtil.evalNotNull("import", "name", name_, String.class, this, pageContext);
        value = (String) ExpressionUtil.evalNotNull("import", "value", value_, String.class, this, pageContext);
    }
}
