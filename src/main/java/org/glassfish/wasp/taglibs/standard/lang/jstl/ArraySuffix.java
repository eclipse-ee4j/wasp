...
public class ArraySuffix extends ValueSuffix {
    ...
    public Object evaluate(Object pValue, Object pContext, VariableResolver pResolver, Map<String, Method> functions, String defaultPrefix, Logger pLogger) throws ELException {
        ...
        // Evaluate the index
        else if ((indexVal = evaluateIndex(pContext, pResolver, functions, defaultPrefix, pLogger)) == null) {
            if (pLogger.isLoggingWarning()) {
        ...
        else if ((property = BeanInfoManager.getBeanInfoProperty(pValue.getClass(), indexStr, pLogger)) != null
