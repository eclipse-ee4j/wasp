...
class JspReader {
    ...
    public JspReader(JspCompilationContext ctxt, String fname, String encoding, JarFile jarFile, ErrorDispatcher err)
            throws WaspException, FileNotFoundException, IOException {
    ...
    public JspReader(JspCompilationContext ctxt, String fname, String encoding, InputStreamReader reader, ErrorDispatcher err)
            throws WaspException, FileNotFoundException {
    ...
    boolean hasMoreInput() throws WaspException
    {
    ...
    int nextChar() throws WaspException
    {
        if (!hasMoreInput()) {
            return -1;
        }
    ...
    String getText(Mark start, Mark stop) throws WaspException
    {
        Mark oldstart = mark();
        reset(start);
    ...
    int peekChar() throws WaspException
    {
        if (!hasMoreInput()) {
            return -1;
        }
    ...
    boolean matchesIgnoreCase(String string) throws WaspException
    {
        Mark mark = mark();
        int ch = 0;
        int i = 0;
     ...
     */
    boolean matches(String string) throws WaspException
    {
        Mark mark = mark();
        int ch = 0;
        int i = 0;
    ...
    boolean matchesETag(String tagName) throws WaspException
    {
        Mark mark = mark();
    ...
    boolean matchesETagWithoutLessThan(String tagName) throws WaspException
    {
        Mark mark = mark();
     ...
     */
    boolean matchesOptionalSpacesFollowedBy(String s) throws WaspException
    {
        Mark mark = mark();
    ...
    int skipSpaces() throws WaspException
    {
        int i = 0;
     ...
     */
    Mark skipUntil(String limit) throws WaspException
    {
        Mark ret = null;
     ...
     * <strong>null</strong> otherwise.
     */
    Mark skipUntilIgnoreEsc(String limit) throws WaspException
    {
        Mark ret = null;
        int limlen = limit.length();
        int ch;
     ...
     * <strong>null</strong> otherwise.
     */
    Mark skipUntilETag(String tag) throws WaspException
    {
    ...
    final boolean isSpace() throws WaspException
    {
     ...
     */
    String parseToken(boolean quoted) throws WaspException
    {
     ...
     * @return A boolean.
     */
    private boolean isDelimiter() throws WaspException
    {
        if (!isSpace()) {
            int ch = peekChar();
     ...
     */
    private void pushFile(String file, String encoding, InputStreamReader reader) throws WaspException, FileNotFoundException {
     ...
     */
    private boolean popFile() throws WaspException
    {
