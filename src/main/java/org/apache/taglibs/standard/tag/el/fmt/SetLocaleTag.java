...
public class SetLocaleTag extends SetLocaleSupport {
    ...
    /**
     * Constructs a new LocaleTag. As with TagSupport, subclasses should not provide other constructors and are expected to
    ...
    private void evaluateExpressions() throws JspException {
        ...
        if (variant_ != null) {
            variant = (String) ExpressionEvaluatorManager.evaluate("variant", variant_, String.class, this, pageContext);
        }
    }
}
