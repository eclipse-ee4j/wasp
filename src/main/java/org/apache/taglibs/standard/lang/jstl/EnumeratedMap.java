 ...
 *
 * <p>
 * This is a Map implementation driven by a data source that only provides an enumeration of keys and a getValue(key)
 * method. This class must be subclassed to implement those methods.
 *
 * <p>
