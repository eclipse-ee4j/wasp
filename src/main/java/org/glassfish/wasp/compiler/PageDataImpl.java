...
class PageDataImpl extends PageData implements TagConstants {
     ...
     */
    public PageDataImpl(Node.Nodes page, Compiler compiler) throws WaspException {
    ...
    static class FirstPassVisitor extends Node.Visitor implements TagConstants {
        ...
        @Override
        public void visit(Node.Root n) throws WaspException {
            visitBody(n);
            if (n == root) {
                /*
                 * Top-level page.
        ...
        private void addRootAttributes(Attributes attrs) throws WaspException {
            if (attrs != null) {
    ...
    static class SecondPassVisitor extends Node.Visitor implements TagConstants {
        ...
        @Override
        public void visit(Node.FallBackAction n) throws WaspException {
            appendTag(n);
        }
         ...
         */
        private void appendTag(Node n) throws WaspException {
            appendTag(n, false);
        }
         ...
         * specified.
         */
        private void appendTag(Node n, boolean addDefaultNS) throws WaspException {
         ...
         */
        private void appendTagDirective(Node.TagDirective n) throws WaspException {
