...
import org.eclipse.wasp.xmlparser.TreeNode;
...
public class TagLibraryInfoImpl extends TagLibraryInfo implements TagConstants {
    ...
    private TagInfo createTagInfo(TreeNode elem, String jspVersion) throws WaspException
    {
        ...
        while (list.hasNext()) {
            ...
            } else if ("example".equals(tname) || "tag-extension".equals(tname)) {
                // Ignored elements
            } else {
    ...
    private TagFileInfo createTagFileInfo(TreeNode elem, String uri, URL jarFileUrl) throws WaspException
    {
        ...
        WaspTagInfo tagInfo = (WaspTagInfo) TagFileProcessor.parseTagFileDirectives(parserController, name, path, this);
        if (checkConflict) {
            ...
            tagInfo = new WaspTagInfo(tagInfo.getTagName(), tagInfo.getTagClassName(), tagInfo.getBodyContent(), description, tagInfo.getTagLibrary(),
