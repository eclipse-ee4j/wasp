...
import org.eclipse.wasp.Constants;
import org.eclipse.wasp.WaspException;
import org.eclipse.wasp.JspCompilationContext;
import org.eclipse.wasp.runtime.JspRuntimeLibrary;
...
class Generator {
    ...
    private void generateTagHandlerInit() {
        ...
        for (String tagHandlerPoolName : tagHandlerPoolNames) {
            ...
            out.print(" = org.eclipse.wasp.runtime.TagHandlerPool.getTagHandlerPool(");
            if (ctxt.isTagFile()) {
                out.print("config");
            } else {
    ...
    private void genPreambleClassVariableDeclarations(String className) throws WaspException
    {
        ...
        if (isPoolingEnabled && !tagHandlerPoolNames.isEmpty()) {
            for (String tagHandlerPoolName : tagHandlerPoolNames) {
                out.printil("private org.eclipse.wasp.runtime.TagHandlerPool " + tagHandlerPoolName + ";");
            }
            out.println();
        }
    ...
    private void generatePreamble(Node.Nodes page) throws WaspException
    {
        ...
        out.printin("    implements org.eclipse.wasp.runtime.JspSourceDependent");
        ...
        if (pageInfo.isErrorPage()) {
            out.printil("Throwable exception = org.eclipse.wasp.runtime.JspRuntimeLibrary.getThrowable(request);");
    ...
    class GenerateVisitor extends Node.Visitor {
        ...
        private String attributeValue(Node.JspAttribute attr, boolean encode, Class expectedType) {
            ...
            if (attr.isExpression()) {
                if (encode) {
                    return "org.eclipse.wasp.runtime.JspRuntimeLibrary.URLEncode(String.valueOf(" + v + "), request.getCharacterEncoding())";
                }
                return v;
            } else if (attr.isELInterpreterInput()) {
                v = JspUtil.interpreterCall(this.isTagFile, v, expectedType, attr.getEL().getMapName(), null, null, null);
                if (encode) {
                    return "org.eclipse.wasp.runtime.JspRuntimeLibrary.URLEncode(" + v + ", request.getCharacterEncoding())";
                }
                return v;
                ...
                if (encode) {
                    return "org.eclipse.wasp.runtime.JspRuntimeLibrary.URLEncode(" + quote(v) + ", request.getCharacterEncoding())";
                }
                return quote(v);
            }
        }
        ...
        private void printParams(Node n, String pageParam, boolean literal) throws WaspException
        {
            ...
            class ParamVisitor extends Node.Visitor {
                ...
                public void visit(Node.ParamAction n) throws WaspException
                {
                    ...
                    out.print(" + ");
                    out.print(
                            "org.eclipse.wasp.runtime.JspRuntimeLibrary.URLEncode(" + quote(n.getTextAttribute("name")) + ", request.getCharacterEncoding())");
                    out.print("+ \"=\" + ");
        ...
        public void visit(Node.IncludeAction n) throws WaspException
        {
            ...
            out.printin("org.eclipse.wasp.runtime.JspRuntimeLibrary.include(request, response, " + pageParam);
        ...
        public void visit(Node.GetProperty n) throws WaspException
        {
            ...
            if (beanInfo.checkVariable(name)) {
                ...
                out.printil("out.write(org.eclipse.wasp.runtime.JspRuntimeLibrary.toString(" + "(((" + beanName + ")_jspx_page_context.findAttribute(" + "\""
                        + name + "\"))." + methodName + "())));");
            } else {
                // The object could be a custom action with an associated
                // VariableInfo entry for this name.
                // Get the class name and then introspect at runtime.
                out.printil("out.write(org.eclipse.wasp.runtime.JspRuntimeLibrary.toString" + "(org.eclipse.wasp.runtime.JspRuntimeLibrary.handleGetProperty"
        ...
        public void visit(Node.SetProperty n) throws WaspException
        {
            ...
            if ("*".equals(property)) {
                out.printil("org.eclipse.wasp.runtime.JspRuntimeLibrary.introspect(" + "_jspx_page_context.findAttribute(" + "\"" + name + "\"), request);");
            } else if (value == null) {
                if (param == null) {
                    param = property; // default to same as property
                }
                out.printil("org.eclipse.wasp.runtime.JspRuntimeLibrary.introspecthelper(" + "_jspx_page_context.findAttribute(\"" + name + "\"), \""
                        + property + "\", request.getParameter(\"" + param + "\"), " + "request, \"" + param + "\", false);");
            } else if (value.isExpression()) {
                out.printil("org.eclipse.wasp.runtime.JspRuntimeLibrary.handleSetProperty(" + "_jspx_page_context.findAttribute(\"" + name + "\"), \""
                        + property + "\",");
                ...
                out.printil("org.eclipse.wasp.runtime.JspRuntimeLibrary.handleSetPropertyExpression(" + "_jspx_page_context.findAttribute(\"" + name
                ...
                out.printin("org.eclipse.wasp.runtime.JspRuntimeLibrary.introspecthelper(" + "_jspx_page_context.findAttribute(\"" + name + "\"), \""
                        + property + "\", ");
                out.print(attributeValue(value, false, null));
        ...
        public void visit(Node.TemplateText n) throws WaspException
        {
            ...
            if (genBytes || ctxt.getOptions().genStringAsCharArray()) {
                ...
                if (genBytes) {
                    out.printin("((org.eclipse.wasp.runtime.JspWriterImpl)out).write(_jspx_same_encoding(response.getCharacterEncoding()), ");
                    out.print(arrayName);
                    out.print(", ");
                    out.print(arrayName);
                    out.println("S);");
        ...
        public void visit(Node.InvokeAction n) throws WaspException
        {
            ...
            // page
            out.printil("((org.eclipse.wasp.runtime.JspContextWrapper) this.jspContext).syncBeforeInvoke();");
        ...
        private String convertString(Class<?> c, String s, String attrName, Class<?> propEditorClass, boolean isNamedAttribute) throws WaspException
        {
            ...
            if (propEditorClass != null) {
                ...
                return "(" + className + ")org.eclipse.wasp.runtime.JspRuntimeLibrary.getValueFromBeanInfoPropertyEditor(" + className + ".class, \""
                ...
                String className = JspUtil.getCanonicalName(c);
                return "(" + className + ")org.eclipse.wasp.runtime.JspRuntimeLibrary.getValueFromPropertyEditorManager(" + className + ".class, \"" + attrName
                        + "\", " + quoted + ")";
            }
        }
        ...
        private void generateJspFragment(Node n, String tagHandlerVar) throws WaspException
        {
            ...
            // the org.eclipse.wasp.runtime package as a support class.
    ...
    private void generateTagHandlerPostamble(TagInfo tagInfo) {
        ...
        out.printil("} finally {");
        out.pushIndent();
        out.printil("((org.eclipse.wasp.runtime.JspContextWrapper) jspContext).syncEndTagFile();");
        if (isPoolingEnabled && !tagHandlerPoolNames.isEmpty()) {
    ...
    private void generateSetJspContext(TagInfo tagInfo) {
        ...
        if (aliasSeen) {
            out.printil("this.jspContext = new org.eclipse.wasp.runtime.JspContextWrapper(ctx, _jspx_nested, _jspx_at_begin, _jspx_at_end, aliasMap);");
        } else {
            out.printil("this.jspContext = new org.eclipse.wasp.runtime.JspContextWrapper(ctx, _jspx_nested, _jspx_at_begin, _jspx_at_end, null);");
        }
        out.popIndent();
        out.printil("}");
        out.println();
    ...
    private void generatePageScopedVariables(WaspTagInfo tagInfo) {
        ...
        for (int i = 0; i < attrInfos.length; i++) {
            ...
            if (attrInfos[i].isDeferredValue()) {
                ...
                out.printin("org.eclipse.wasp.runtime.PageContextImpl.setValueVariable(");
                out.print("_jspx_page_context, ");
                out.print(quote(attrName));
                out.print(", ");
                out.print(toGetterMethod(attrName));
            ...
            if (attrInfos[i].isDeferredMethod()) {
                ...
                out.printin("org.eclipse.wasp.runtime.PageContextImpl.setMethodVariable(");
                out.print("_jspx_page_context, ");
                out.print(quote(attrName));
                out.print(", ");
                out.print(toGetterMethod(attrName));
    ...
    private static class FragmentHelperClass {
        ...
        public void generatePreamble() {
            ...
            out.printil("    extends " + "org.eclipse.wasp.runtime.JspFragmentHelper");
            out.printil("{");
            out.pushIndent();
