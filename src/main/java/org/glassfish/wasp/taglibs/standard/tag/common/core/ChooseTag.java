 ...
 *
 * <p>
 * &lt;choose&gt; is a very simple tag that acts primarily as a container; it always includes its body and allows
 * exactly one of its child &lt;when&gt; tags to run. Since this tag handler doesn't have any attributes, it is
 * common.core to both the rtexprvalue and expression- evaluating versions of the JSTL library.
 *
 * @author Shawn Bayern
 */
...
public class ChooseTag extends TagSupport {
     ...
     *
     * @return <tt>true</tt> if the subtag should evaluate its condition and decide whether to run, <tt>false</tt>
     * otherwise.
     */
