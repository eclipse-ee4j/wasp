...
import org.glassfish.wasp.taglibs.standard.tag.common.fmt.ParseDateSupport;
...
public class ParseDateTag extends ParseDateSupport {
    ...
    /**
     * Constructs a new ParseDateTag. As with TagSupport, subclasses should not provide other constructors and are expected
    ...
    private void evaluateExpressions() throws JspException {
        ...
        if (parseLocale_ != null) {
            Object obj = ExpressionEvaluatorManager.evaluate("parseLocale", parseLocale_, Object.class, this, pageContext);
            if (obj != null) {
