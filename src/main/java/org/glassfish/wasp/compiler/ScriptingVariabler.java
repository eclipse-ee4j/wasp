...
class ScriptingVariabler {
    ...
    static class ScriptingVariableVisitor extends Node.Visitor {
        ...
        private void setScriptingVars(Node.CustomTag n, int scope) throws WaspException {
    ...
    public static void set(Node.Nodes page, ErrorDispatcher err) throws WaspException {
