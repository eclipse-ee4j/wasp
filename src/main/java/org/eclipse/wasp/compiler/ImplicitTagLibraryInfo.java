...
class ImplicitTagLibraryInfo extends TagLibraryInfo {
     ...
     * Constructor.
     */
    public ImplicitTagLibraryInfo(JspCompilationContext ctxt, ParserController pc, String prefix, String tagdir, ErrorDispatcher err) throws WaspException
    {
        super(prefix, null);
        this.pc = pc;
        this.err = err;
     ...
     */
    private void parseImplicitTld(JspCompilationContext ctxt, String path) throws WaspException
    {
