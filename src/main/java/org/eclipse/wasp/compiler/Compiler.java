...
public class Compiler {
    ...
    private void initJavaCompiler() throws WaspException
    {
        ...
        if (javaCompiler == null) {
            boolean disablejsr199 = Boolean.TRUE.toString().equals(System.getProperty("org.eclipse.wasp.compiler.disablejsr199"));
            ...
            if (!disablejsr199 && (version >= 1.6 || getClassFor("javax.tools.Tool") != null)) {
                ...
                if (c != null) {
                    c = getClassFor("org.eclipse.wasp.compiler.JDTJavaCompiler");
                    if (c != null) {
                        try {
                            javaCompiler = (JavaCompiler) c.newInstance();
                        } catch (Exception ex) {
        ...
        if (javaCompiler == null) {
            ...
            if (c != null) {
                c = getClassFor("org.eclipse.wasp.compiler.AntJavaCompiler");
                if (c != null) {
                    try {
                        javaCompiler = (JavaCompiler) c.newInstance();
                    } catch (Exception ex) {
