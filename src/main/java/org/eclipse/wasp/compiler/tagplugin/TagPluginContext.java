...
package org.eclipse.wasp.compiler.tagplugin;

/**
 * This interface allows the plugin author to make inqueries about the properties of the current tag, and to use Wasp
...
public interface TagPluginContext {
    ...
    /**
     * Abandon optimization for this tag handler, and instruct Wasp to generate the tag handler calls, as usual. Should be
