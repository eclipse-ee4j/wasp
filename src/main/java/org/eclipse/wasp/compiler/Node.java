...
import org.eclipse.wasp.compiler.tagplugin.TagPluginContext;
...
abstract class Node implements TagConstants {
     ...
     */
    abstract void accept(Visitor v) throws WaspException;
    ...
    public static class Visitor {
         ...
         * need to.
         */
        protected void doVisit(Node n) throws WaspException
        {
        }
         ...
         */
        protected void visitBody(Node n) throws WaspException
        {
            if (n.getBody() != null) {
        ...
        public void visit(JspRoot n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(PageDirective n) throws WaspException
        {
            doVisit(n);
        }

        public void visit(TagDirective n) throws WaspException
        {
            doVisit(n);
        }

        public void visit(IncludeDirective n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(TaglibDirective n) throws WaspException
        {
            doVisit(n);
        }

        public void visit(AttributeDirective n) throws WaspException
        {
            doVisit(n);
        }

        public void visit(VariableDirective n) throws WaspException
        {
            doVisit(n);
        }

        public void visit(Comment n) throws WaspException
        {
            doVisit(n);
        }

        public void visit(Declaration n) throws WaspException
        {
            doVisit(n);
        }

        public void visit(Expression n) throws WaspException
        {
            doVisit(n);
        }

        public void visit(Scriptlet n) throws WaspException
        {
            doVisit(n);
        }

        public void visit(ELExpression n) throws WaspException
        {
            doVisit(n);
        }

        public void visit(IncludeAction n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(ForwardAction n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(GetProperty n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(SetProperty n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(ParamAction n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(ParamsAction n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(FallBackAction n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(UseBean n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(PlugIn n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(CustomTag n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(UninterpretedTag n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(JspElement n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(JspText n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(NamedAttribute n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(JspBody n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(InvokeAction n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(DoBodyAction n) throws WaspException
        {
            doVisit(n);
            visitBody(n);
        }

        public void visit(TemplateText n) throws WaspException
        {
            doVisit(n);
        }

        public void visit(JspOutput n) throws WaspException
        {
            doVisit(n);
        }

        public void visit(AttributeGenerator n) throws WaspException
        {
            doVisit(n);
        }
    }
