...
public class PageInfo {
     ...
     *
     * @param useDefault TRUE if the default (org.eclipse.wasp.runtime.HttpJspBase) should be returned if this attribute
     * has not been set, FALSE otherwise
     *
     * @return The value of the 'extends' page directive attribute, or the default (org.eclipse.wasp.runtime.HttpJspBase)
